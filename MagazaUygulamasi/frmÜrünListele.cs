...
namespace MagazaUygulamasi
{
    public partial class frmÜrünListele : Form
    {
        ...
        private void txtUrunAdıAra_TextChanged(object sender, EventArgs e)
        {
            DataTable tablo = new DataTable();
            baglanti.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("select * from urun where urunadi like '%" + txtUrunAdıAra.Text + "%'", baglanti);
            adtr.Fill(tablo);
